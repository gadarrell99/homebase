...
PROJECTS = [
    {"name": "bps-ai", "server_ip": "192.168.65.246", "user": "bpsaiadmin", "path": "~/bps-ai"},
    {"name": "context-hub", "server_ip": "192.168.65.247", "user": "contextadmin", "path": "/opt/it-context-hub"},
    {"name": "property-rize", "server_ip": "192.168.65.243", "user": "cobaltadmin", "path": "~/property-rize"},
    {"name": "homebase", "server_ip": "192.168.65.243", "user": "cobaltadmin", "path": "~/homebase"},
